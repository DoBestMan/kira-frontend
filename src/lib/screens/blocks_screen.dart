              ...
              onTap: () {
                ...
                if (!isHashActive && int.parse(heightQuery) > networkService.latestBlockHeight) {
                  AlertDialog alert = AlertDialog(
                      ...
                      content: Text(Strings.invalid_block_height + networkService.latestBlockHeight.toString()));
                  showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return alert;
                ...
                networkService
                    .searchBlock(isHashActive
                        ? hashQuery.startsWith("0x")
                            ? hashQuery
                            : "0x$hashQuery"
                        : int.parse(heightQuery).toString())
                    .then((v) {
                  this.setState(() {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Flexible(
                          flex: 5,
                          child: Text(filteredBlock.getProposerString(),
                              style: TextStyle(color: KiraColors.white.withOpacity(0.8), fontSize: 14)),
                        )
                      ],
                    ),
              ...
              .map((transaction) => Card(
                  ...
                  child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Expanded(
                            flex: 1,
                            child: Text(filteredBlock.getTimeString(),
                                style: TextStyle(color: KiraColors.white.withOpacity(0.8), fontSize: 16),
                                textAlign: TextAlign.end)),
                        SizedBox(width: 10),
                        Expanded(
                            ...
                            child: Container(
                                ...
                                child: InkWell(
                                  child: Padding(
                                    ...
                                    child:
                                        Icon(Icons.circle, size: 12.0, color: filteredTransactions[0].getStatusColor()),
                                  ),
                                )))
                      ]))))
              .toList()
