...
class _BlocksTableState extends State<BlocksTable> {
  ...
  Widget addRowHeader(Block block, bool isExpanded) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(flex: 1, child: Text(block.getHeightString(), style: TextStyle(color: KiraColors.white.withOpacity(0.8), fontSize: 16))),
          SizedBox(width: 10),
          Expanded(
              flex: 2,
              child: Row(children: [
                ...
                SizedBox(width: 5),
                Text(block.getProposer, overflow: TextOverflow.ellipsis, style: TextStyle(color: KiraColors.white.withOpacity(0.8), fontSize: 16))
              ])),
          SizedBox(width: 10),
          Expanded(flex: 1, child: Text(block.txAmount.toString(), textAlign: TextAlign.end, style: TextStyle(color: KiraColors.white.withOpacity(0.8), fontSize: 16))),
          SizedBox(width: 10),
          Expanded(flex: 1, child: Text(block.getTimeString(), textAlign: TextAlign.end, style: TextStyle(color: KiraColors.white.withOpacity(0.8), fontSize: 16)))
        ],
      ),
    );
  }
    ...
    return widget.transactions.isEmpty
        ...
        child: Column(children: [
          Container(
              ...
              child: Row(children: [
                Expanded(flex: 1, child: Text("Tx Hash", style: TextStyle(color: KiraColors.kGrayColor, fontSize: 16, fontWeight: FontWeight.bold))),
                SizedBox(width: 10),
                Expanded(flex: ResponsiveWidget.isSmallScreen(context) ? 2 : 4, child: Text("Type", style: TextStyle(color: KiraColors.kGrayColor, fontSize: 16, fontWeight: FontWeight.bold))),
                SizedBox(width: 10),
            ...
            Expanded(
                ...
                child: Align(
                    ...
                    child: InkWell(
                        ...
                        child: Text(transaction.getReducedHash, overflow: TextOverflow.ellipsis, style: TextStyle(color: KiraColors.white.withOpacity(0.8), fontSize: 16))))),
            SizedBox(width: 10),
            Expanded(
